...
public class Balloon extends Observable {
	...
	/**
	 * Create a Balloon with the given color and a default capacity of 50.
	 *
	 * @param color		The colour of this balloon
	 */
	public Balloon(String color) {
		// "this" is like Python's "self"
		this(color, 50); // call the other OVERLOADED constructor
	}

	/**
	 * Create a Balloon with the given color and capacity (max capacity is 100).
	 *
